...
// === KOMARI 配置 (替换原哪吒配置) ===
// ============================================
const KOMARI_ENDPOINT = process.env.KOMARI_ENDPOINT || '';  // Komari 服务器地址 (完整URL，如: https://km.bcbc.pp.ua)
...
async function downloadFilesAndRun() {
  ...
  if (KOMARI_ENDPOINT && KOMARI_TOKEN) {
    ...
    console.log('KOMARI_ENDPOINT or KOMARI_TOKEN is empty, skip running Komari agent');
  }
